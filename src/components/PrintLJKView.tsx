      ...
      <div className="flex justify-center">
        <div 
          ...
          className={`w-full max-w-[840px] bg-white text-slate-900 border-2 border-slate-800 shadow-xl rounded-sm p-6 sm:p-7 relative print:border-2 print:border-black print:p-5 print:shadow-none print:m-0 print:w-full print:max-w-none select-none ${
            paperSize === 'F4' ? 'min-h-[1140px]' : 'min-h-[1010px]'
          }`}
          style={{ fontFamily: "'Plus Jakarta Sans', Arial, sans-serif" }}
        >
          {/* Paper Size Watermark Indicator for screen verification */}
          <div className="print:hidden absolute top-3 right-12 text-[9px] font-bold text-slate-400 border border-slate-200 px-2 py-0.5 rounded bg-slate-50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3 mb-3">
            {/* Box 1: Identitas Siswa (6 cols on md) */}
            <div className="md:col-span-6 border-2 border-black p-2.5 rounded-xs space-y-1.5 flex flex-col justify-between">
            ...
            {/* Box 2: NOMOR ABSEN OMR BUBBLE (MENDATAR / HORIZONTAL) (6 cols on md) */}
            <div className="md:col-span-6 border-2 border-black p-2.5 rounded-xs bg-slate-50/70 flex flex-col justify-between">
